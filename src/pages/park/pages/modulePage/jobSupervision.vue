...
const config = reactive({
        ...
        data: [
                ['高空作业', '需使用护具和防护绳', '赵业聪', '吊车'],
                ['引爆化学品', '需要专业技能和设备配合', '崔永川', '防护服'],
                ['雷区作业', '需在雷区内进行施工', '许晓朋', '防护服'],
                ['雷区作业', '需在雷区内进行施工', '姜宏连', '防护服'],
                ['高空作业', '需使用护具和防护绳', '刘杰', '吊车'],
        ],
        waitTime:5000,
        rowNum: 4,
        headerBGC: 'none',
...
const config1 = reactive({
        ...
        data: [
                ['硝化车间', 25.6, 60.2, 68.5, '2021-06-01 12:30:00'],
                ['桃红车间', 26.5, 65.4, 70.2, '2021-06-01 14:30:00'],
                ['硫化车间', 24.8, 60.3, 65.8, '2021-06-02 15:00:00'],
                ['硝化车间', 25.8, 55.5, 60.0, '2021-06-03 11:00:00'],
                ['硫化车间', 24.8, 59.1, 85.0, '2021-06-05 09:00:00']
        ],
        waitTime:5000,
        rowNum: 4,
        headerBGC: 'none',
...
const config2 = reactive({
        ...
        data: [
                ...
                ['人员违规', '低', '员工刘杰违规操作', '2021-06-02 10:00:00'],
                ['人员违规', '低', '员工许晓朋违规操作', '2021-06-03 10:00:00'],
